...
from cloudeyeclient.osc import plugin
...
class TestCloudEyePlugin(base.BaseTestCase):
    ...
    def test_plugin_parser(self):
        ...
        parsed = parser.parse_args(['--os-cloudeye-api-version',
                                    '1',
                                    '--os-cloudeye-endpoint-override',
                                    'http://cloudeye.endpoint'])
        self.assertEqual(parsed.os_cloudeye_api_version, "1")
        self.assertEqual(parsed.os_cloudeye_endpoint_override,
                         'http://cloudeye.endpoint')
